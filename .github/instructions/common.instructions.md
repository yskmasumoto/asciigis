...
- Go コードの構成方針は [.github/instructions/go.instructions.md](.github/instructions/go.instructions.md) を前提にレビューする。
- TUI（Bubble Tea / Lip Gloss）領域は [.github/instructions/tui.instructions.md](.github/instructions/tui.instructions.md) を前提にレビューする。
